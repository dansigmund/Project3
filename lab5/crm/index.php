...
*/
  ...
  foreach($customers as $cust)  {      
       echo '<tr>';
       echo '<td class="mdl-data-table__cell--non-numeric"><a href="index.php?customer=' . $cust['id'] .'">' . $cust['name'] . '</a></td>';
...
<?php echo $requestedCustomer['city'] . "," . $requestedCustomer['country']?><br>
